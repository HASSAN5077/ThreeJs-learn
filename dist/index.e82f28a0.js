...
})({"wh02u":[function(require,module,exports) {
"use strict";
...
const gridHelper = new _three.GridHelper(30, 30);
...
const directionLight = new _three.DirectionalLight(0xffffff, 0.8);
scene.add(directionLight);
directionLight.position.set(-30, 50, 10);
const dLightHelper = new _three.DirectionalLightHelper(directionLight);
...
},{"three":"ktPTu","three/examples/jsm/controls/OrbitControls.js":"7mqRv","dat.gui":"k3xQk","../img/nebula.jpg":"1Y6Wr","../img/stars.jpg":"edLK9","@parcel/transformer-js/src/esmodule-helpers.js":"l9jfw"}],"1Y6Wr":[function(require,module,exports) {
module.exports = require("./helpers/bundle-url").getBundleURL("2MSMO") + "nebula.a535bdf2.jpg" + "?" + Date.now();

},{"./helpers/bundle-url":"iZF9Z"}],"edLK9":[function(require,module,exports) {
module.exports = require("./helpers/bundle-url").getBundleURL("2MSMO") + "stars.a1d7fe60.jpg" + "?" + Date.now();

},{"./helpers/bundle-url":"iZF9Z"}]},["wh02u","dV6cC"], "dV6cC", "parcelRequire94c2")
